...
import com.example.demo.activity.util.TimeUtils;
...
//	}
	...
	public boolean getIsNextGatewaty() {
		return isNextGatewaty;
	}

	public void setIsNextGatewaty(boolean isNextGatewaty) {
		this.isNextGatewaty = isNextGatewaty;
	}
}
